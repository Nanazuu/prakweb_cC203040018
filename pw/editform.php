...
<div class="container bg-info" style="padding-top: 20px; padding-bottom: 20px;">
 ...
 <div class="form-group">
  ...
  <input type="text" name="judul" class="form-control" value="<?php echo $row['judul_buku']; ?>">   
 </div>
 ...
 <div class="form-group">
  ...
  <input type="text" name="tgl_rilis" class="form-control" value="<?php echo $row['tgl_rilis']; ?>">   
 </div>
